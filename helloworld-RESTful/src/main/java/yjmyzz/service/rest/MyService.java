...
import yjmyzz.service.model.Book;
import yjmyzz.service.model.Product;
import yjmyzz.service.model.User;
...
public class MyService {
    ...
    public JAXBElement<String> getHelloWorldJSON() {
        JAXBElement<String> result = new JAXBElement<>(new QName("",
